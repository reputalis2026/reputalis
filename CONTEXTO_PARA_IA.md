...
- **PK:** UUID
- **Fillable:** `id`, `client_id`, `default_locale`, `title`, `title_es`, `title_pt`, `title_en`, `display_mode`, `survey_question_text`, `survey_question_text_es`, `survey_question_text_pt`, `survey_question_text_en`
