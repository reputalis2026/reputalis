    ...
    <style>
        ...
        @media (min-width: 1280px) {
            .client-dashboard-insights-row .client-dashboard-employee-row {
                grid-template-columns: 1fr 5.25rem 5rem 3.75rem;
                gap: .35rem .45rem;
                min-height: 4.85rem;
        ...
        .client-dashboard-employee-row {
            position: relative;
            display: grid;
            grid-template-columns: 1fr 5.85rem 5.5rem 4rem;
            align-items: center;
            gap: .4rem .5rem;
            min-height: 5.35rem;
            margin-bottom: .55rem;
        ...
        .client-dashboard-employee-detail-bottom.has-improvement {
            grid-template-columns: minmax(0, 1.35fr) minmax(13rem, .95fr);
            gap: 1rem;
        }
                ...
                <div class="client-dashboard-row-1">
                    ...
                    >
                        ...
                        <div class="client-dashboard-main-summary-grid flex-1 p-4">
                            <div class="client-dashboard-main-summary-metric flex min-h-[15rem] flex-col rounded-lg bg-gray-50 p-3 dark:bg-gray-800">
                                <p class="client-dashboard-metric-label">
                                    {{ __('client.dashboard.main_summary.obtained_rating') }}
                                </p>
                                <div class="mx-auto mt-2 flex h-[12rem] min-h-0 w-full flex-1 items-center justify-center">
                                    <div wire:ignore data-dashboard-chart="gauge" class="h-[180px] w-[180px]"></div>
                                </div>
                            </div>
                            ...
                            <div class="client-dashboard-main-summary-metric flex min-h-[15rem] flex-col rounded-lg bg-gray-50 p-3 dark:bg-gray-800">
                                ...
                                <div class="mx-auto mt-2 flex h-[12rem] min-h-0 w-full flex-1 items-center justify-center">
                                    <div wire:ignore data-dashboard-chart="satisfied" class="h-[180px] w-[180px]"></div>
                                </div>
                            </div>
                            ...
                            <div class="client-dashboard-main-summary-metric flex min-h-[15rem] flex-col rounded-lg bg-gray-50 p-3 dark:bg-gray-800">
                                ...
                                <div wire:ignore data-dashboard-chart="breakdown" class="mt-7 h-[12rem] min-h-0 w-full flex-1"></div>
                            </div>
                        </div>
                    </section>
                </div>
                        ...
                        <div class="client-dashboard-survey-history-header">
                            ...
                            <div class="client-dashboard-survey-history-actions">
                                ...
                                <button
                                    ...
                                    @class(['client-dashboard-survey-history-pill', 'is-active' => $survey_history_grouping === 'hours'])
                                >
                                            ...
                                            <div class="client-dashboard-employee-bars" aria-label="{{ __('client.dashboard.employee_ranking.rating_distribution') }}">
                                                @foreach ($ratingGroups as $group)
                                                    <span
                                                        ...
                                                        title="{{ $group['label'] }}/5: {{ $group['count'] }}"
                        ...
                        @if (count($improvementRanking['options']) > 0)
                            <div class="client-dashboard-improvement-ranking-scroll">
                                @foreach ($improvementRanking['options'] as $option)
                                    <article class="client-dashboard-improvement-row">
